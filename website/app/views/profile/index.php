...
<div class="grid grid-cols-12 gap-x-8 my-5 relative">
    <div class="col-span-4 h-full">
        ...
        <h1 class="text-3xl font-sans! leading-none font-bold mt-5 flex items-center">
            <?php echo tiny::data()->profile['first_name']; ?> <?php echo tiny::data()->profile['last_name']; ?>
        ...
        <?php if (tiny::data()->profile['bio']): ?>
            <p class="my-5! text-base subpixel-antialiased leading-[1.8] opacity-80 text-pretty"><?php echo htmlspecialchars(tiny::data()->profile['bio']); ?></p>
        <?php endif; ?>
    ...
    <div class="col-span-8 h-full">
        <h2 class="text-3xl font-semibold font-sans! border-b pb-3 mb-4">Formations</h2>
