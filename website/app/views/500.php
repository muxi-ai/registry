...
<div class="p-5 mt-32 mb-16 min-h-96 flex flex-col justify-center items-center text-center">
    <div class="max-w-md mx-auto">
        <h1 class="text-4xl font-bold"><?php echo tiny::layout()->props('code') ?: 501; ?></h1>

        <?php if (@tiny::data()->error): ?>
            <div class="font-mono text-sm my-6">
                <?php echo tiny::data()->error; ?>
            </div>
        <?php else: ?>
            <div class="text-sm mt-6 mb-4">An application error occurred</div>
        <?php endif; ?>
