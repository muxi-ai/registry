...
class Auth extends TinyController
{
    ...
    public function get($request, $response)
    {
        ...
        $url = "https://github.com/login/oauth/authorize?client_id={$_SERVER['APP_GITHUB_APP_CLIENT_ID']}&redirect_uri={$redirect_uri}&scope=public_repo,delete_repo,read:org,user:email&state={$state}";
