...
<div class="alert mb-9 pt-5 -mt-2">
    ...
    <h2 class="text-lg">Free and open — a proof of concept</h2>
    <section class="text-balanced">
        <p class="mt-2! mb-0!">
            Currently, <a href="/@muxi/hello-muxi" class="link whitespace-nowrap"><code>@muxi/hello-muxi</code></a>
            is our one official formation. Run it, see agents collaborate live, sign the guestbook.
        </p>
        <p class="my-2!">
            The registry is open to everyone: build your own and <code>muxi push</code> it with the MUXI CLI.
        </p>
    </section>
</div>
