    ...
    <footer id="footer" class="w-full container @container">
        <div class="mt-20 pt-8 lg:border-t dark:border-white/5">
            <div class="lg:flex gap-4 mb-3 lg:gap-20">
                <div class="col-span-full lg:w-5/12 mt-4">
                    <a href="/" class="text-xl font-black leading-none text-gray-900 select-none logo block w-fit hover:scale-105 tranision-all duration-150">
                    ...
                    <p class="my-6 text-sm text-black opacity-70">
                        ...
                        Licensed under <a class="text-bright hover:border-b-2 font-medium" target="_blank" href="/go/licensing">Elastic License 2.0 and Apache 2.0</a>.
                    </p>
                    <p class="pt-2 flex items-center space-x-4 [&>a]:hover:scale-125 [&>a]:transform-scale [&>a]:duration-300 [&>a]:text-black [&>a]:dark:text-[#fcf0df] [&>a]:opacity-50 [&>a]:hover:opacity-100">
                        <a target="_blank" href="/go/github" target="github">
                        ...
                        <a target="_blank" href="/go/x" target="twitter">
                        ...
                        <a target="_blank" href="/go/linkedin" target="linkedin">
                        ...
                        <!--
                        <a target="_blank" href="/go/youtube" target="youtube">
                        ...
                        -->
                        <a target="_blank" href="/go/luma" target="luma" class="-ml-0.5" data-side="right" data-tooltip="Attend a live workshop">
                    ...
                    <p class="text-xs leading-normal">
                        <a href="/llms.txt" class="opacity-50 hover:opacity-100">Are you an AI? Here\'s <code>llms.txt</code></a><br>
                        <a href="/llm-status" class="flex items-center space-x-1.5 pt-1"><span class="opacity-60 hover:opacity-100">LLM Status </span><img src="/llm-status/badge.svg" alt="status" class="inline size-2.5 mt-px"></a>
                    </p>
                </div>
                <div class="flex gap-6 lg:w-7/12 items-start">
                    <nav class="w-1/3 [&>a]:flex [&>a]:mb-2 [&>a]:text-xs lg:[&>a]:text-sm [&>a]:font-normal [&>a]:text-inherit [&>a]:transition-all [&>a]:duration-300 [&>a]:opacity-70 [&>a]:hover:opacity-100 [&>a]:hover:font-medium [&>a]:hover:after:content-[\'→\'] [&>a]:hover:after:translate-x-1 [&>a]:hover:after:transition-transform [&>a]:hover:after:duration-300">
                        ...
                        <a href="/docs/server/">MUXI Server</a>
                        <a href="/docs/runtime/">MUXI Runtime</a>
                        <a href="/docs/registry/">MUXI Registry</a>
                        <a href="/docs/cli/">MUXI CLI</a>
                        <a href="/docs/sdks/">MUXI SDKs</a>
                    </nav>
                    <nav class="w-1/3 [&>a]:flex [&>a]:mb-2 [&>a]:text-xs lg:[&>a]:text-sm [&>a]:font-normal [&>a]:text-inherit [&>a]:transition-all [&>a]:duration-300 [&>a]:opacity-70 [&>a]:hover:opacity-100 [&>a]:hover:font-medium [&>a]:hover:after:content-[\'↗\'] [&>a]:hover:after:translate-x-1 [&>a]:hover:after:transition-transform [&>a]:hover:after:duration-300">
                        <p class="mb-3 text-xs tracking-wider text-bright opacity-70 uppercase font-semibold">Resources</p>
                        <a target="_blank" href="/go/luma">Workshops</a>
                        <a target="_blank" href="/go/community">Discussions</a>
                        <a target="_blank" href="/go/changelog">Changelog</a>
                        <a target="_blank" href="/go/roadmap">Roadmap</a>
                        <a target="_blank" href="/go/contributing">Contributing</a>
                        <a target="_blank" href="/go/sponsors" class="whitespace-nowrap opacity-90! hover:opacity-100!">GitHub <span class="animate-rainbow-text ml-1">Sponsors</span></a>
                    </nav>
                    <nav class="w-1/3 [&>a]:flex [&>a]:mb-2 [&>a]:text-xs lg:[&>a]:text-sm [&>a]:font-normal [&>a]:text-inherit [&>a]:transition-all [&>a]:duration-300 [&>a]:opacity-70 [&>a]:hover:opacity-100 [&>a]:hover:font-medium [&>a]:hover:after:content-[\'›\'] [&>a]:hover:after:translate-x-1 [&>a]:hover:after:transition-transform [&>a]:hover:after:duration-300">
                        <p class="mb-3 text-xs tracking-wider text-bright opacity-70 uppercase font-semibold">Get Started</p>
                        <a href="/docs/quickstart">Quickstart</a>
                        <a href="/docs/how-it-works">How MUXI Works</a>
                        <a href="/docs/examples/">Examples</a>
                        <a href="/go/registry">Recipes</a>
                        <a href="/docs">Docs</a>
                    </nav>
                </div>
            </div>
        ...
        <div class="pt-10 mt-10 pb-12 mx-auto max-w-7xl text-[13px] text-center leading-relaxed! border-t dark:border-white/5 group">
            ...
            <p>
                ...
                <a href="/privacy" class="transition-opacity duration-300 opacity-60 hover:opacity-100">Privacy</a>
                <span class="opacity-60">&nbsp;/&nbsp; </span>
                <a href="/terms" class="transition-opacity duration-300 opacity-60 hover:opacity-100">Terms</a>
                <span class="opacity-60">&nbsp;/&nbsp; </span>
                <a href="/support" class="transition-opacity duration-300 opacity-60 hover:opacity-100">Support</a>
            </p>
        </div>
    </footer>';
});
