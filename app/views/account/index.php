...
<div class="grid grid-cols-12 gap-x-8 my-5 relative">
    <div class="col-span-4 h-full">
        ...
        <?php if (tiny::user()->bio): ?>
            <p class="my-5! text-base subpixel-antialiased leading-[1.8] opacity-80 text-pretty"><?php echo preg_replace('/@([a-zA-Z0-9_-]+)/', '<a href="/@$1" class="text-black dark:text-white font-medium hover:text-blue-500!">@$1</a>', htmlspecialchars(tiny::user()->bio)); ?></p>
        <?php endif; ?>
